...
data_seq = genfromtxt('../plots/slurm/v4/NACA0015/output_seq_linear.txt', delimiter=' ')
data_cilk_t = genfromtxt('../plots/slurm/v4/NACA0015/cilk/output.txt', delimiter=' ')
data_openmp_t = genfromtxt('../plots/slurm/v4/NACA0015/openmp/output.txt', delimiter=' ')
data_openmp_static_t = genfromtxt('../plots/slurm/v4/NACA0015/openmp/static/output.txt', delimiter=' ')
data_pthread_t = genfromtxt('../plots/slurm/v4/NACA0015/pthread/output.txt', delimiter=' ')
